...
const LoadTimelineGraph = ({ stages }: { stages: any[] }) => {
  ...
  return (
    <svg width={width} height={height} style={{ display: 'block' }}>
      <defs>
        <linearGradient id="easyLoadGradient" x1="0%" y1="0%" x2="0%" y2="100%">
...
export default function Phase1() {
  ...
  const handleNext = () => {
    ...
    router.push(`/prototype/phase2?pattern=${patternId}&mode=${mode}`)
  }
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', background: 'white', borderRadius: '12px', padding: '2rem' }}>
        <div style={{ marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.8rem', marginBottom: '0.5rem' }}>
            {patternNames[patternId] || 'Load Test'}
          </h1>
        ...
        <div style={{
          ...
          <h3 style={{ marginBottom: '1rem' }}>Your Load Pattern</h3>
          <div style={{
            background: 'white',
            borderRadius: '8px',
            padding: '1rem',
...
{stageFormat}
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '0.5rem' }}>
            📊 Pattern: {patternNames[patternId] || 'Custom'}
          </div>
          <p style={{ marginTop: '1rem', fontSize: '0.9rem', color: '#666' }}>
            This test will simulate {peakUsers} users over {totalDuration} minutes.
